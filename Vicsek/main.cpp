...
//	float(Engine::*compute_param)(float) = &Engine::compute_cluster_segregity;
//
//	float min_valx = 20.f;
//	float max_valx = 60.f;
//	float cur_valx = min_valx;
...
//				{
//					engine.run_for(same_sim_mean_run_time);
//					buf_mean += (engine.*compute_param)(d_range); //change the argument if using the compute segregity cluster
//				}
//				
//				computed_val_mean += buf_mean / n_same_sim_means;
//			}
